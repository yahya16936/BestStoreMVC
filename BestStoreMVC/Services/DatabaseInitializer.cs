...
namespace BestStoreMVC.Services
{
    public class DatabaseInitializer
    {
            ...
            RoleManager<IdentityRole>? roleManager)
        {
            ...
            {
                Console.WriteLine("userManager and roleManager is null => exit");
                return;
            }
            ...
            if (!exists)
            {
                Console.WriteLine("Admin role is not define and will be created");
            ...
            if (!exists)
            {
                Console.WriteLine("Seller role is not define and will be created");
            ...
            if (!exists)
            {
                Console.WriteLine("Client role is not define and will be created");
